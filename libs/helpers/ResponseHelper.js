...
function getCode(message) {
  ...
  try {
    ...
    else if (message.includes("phone is invalid")) code = ResponseCode.PHONE_NOT_VALID;
    else if (message.includes("email exists")) code = ResponseCode.EMAIL_EXISTS;
    else if (message.includes("code is invalid")) code = ResponseCode.VERFIY_CODE_NOT_VALID;
